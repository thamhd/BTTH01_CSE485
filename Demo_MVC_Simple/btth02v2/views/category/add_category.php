        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="/Demo_MVC_Simple/btth02v2/views/category/index_category.php">Thể loại</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Demo_MVC_Simple/btth02v2/views/author.php">Tác giả</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Demo_MVC_Simple/btth02v2/views/article.php">Bài viết</a>
                    </li>
                </ul>
            </div>
        </div>
