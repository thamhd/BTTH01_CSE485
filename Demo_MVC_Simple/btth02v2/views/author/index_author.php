...
// Kiểm tra nếu có tham số `id` được gửi để xoá tác giả
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <table class="table">
                ...
                <tbody>
                <?php 
                    //Duyet danh sach tac gia
                    foreach ($authors as $index => $author) {
                        echo "<tr>";
                        echo "<th scope='row'>" . ($index + 1) . "</th>";
                        echo "<td>" . htmlspecialchars($author->getName()) . "</td>";
                        echo "<td><a href='edit_author.php?controller=author&id=" . $author->getId() . "' class='text-primary'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                        echo "<td><a href='index_author.php?controller=author&action=delete&id=" . $author->getId() . "' class='text-danger'><i class='fa-solid fa-trash'></i></a></td>";
                        echo "</tr>";
                    }
                ?>
                </tbody>
